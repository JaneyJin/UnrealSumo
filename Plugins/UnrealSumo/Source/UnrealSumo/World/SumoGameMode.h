...
#include "Client.h"
#include "UnrealSumo/Vehicle/VehicleInformation.h"
...
UENUM()
enum class ETrafficLightController : uint8 {
    SumoTrafficLight  UMETA(DisplayName = "Sumo Traffic Light"),
    UnrealTrafficLight UMETA(DisplayName = "Unreal Traffic Light")
};
